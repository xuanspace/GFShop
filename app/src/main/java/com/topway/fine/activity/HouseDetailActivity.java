...
public class HouseDetailActivity extends SwipeBackActivity {
    ...
    @Bind(R.id.textHeadTitle) TextView textHeadTitle;
    @Bind(R.id.pager) AutoLoopViewPager pager;
    ...
    public class GalleryPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            item.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(HouseDetailActivity.this, GalleryBrowseActivity.class);
