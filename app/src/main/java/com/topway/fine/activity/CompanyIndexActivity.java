...
import com.topway.fine.adapter.CompanyAdapter;
...
public class CompanyIndexActivity extends BaseActivity {
    ...
    private CompanyIndexActivity context;
    private CompanyIndexAdapter adapter;
    ...
    public void initListView() {
        ...
        adapter = new CompanyIndexAdapter(context, listView);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Company item = (Company) adapter.getItem(position);
                //finishActivityResult(item);
                showCompanyDeatil(item);
            }
        });
    }

    public void showCompanyDeatil(Company item) {
