...
public class LogUtil {
    ...
    public static String customTagPrefix = "topway";
    private static final boolean isSaveLog = false; // 是否把保存日志到SD卡中
    public static final String ROOT = Environment.getExternalStorageDirectory().getPath() + "/topway/"; // SD卡中的根目录
