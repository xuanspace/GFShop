package com.topway.fine.widget;
...
public class AnimateCheckBox extends View {
    ...
    public AnimateCheckBox(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        circleColor = a.getColor(R.styleable.AnimateCheckBox_animCheckedColor, DEFAULT_CHECKED_COLOR);
        unCheckColor = a.getColor(R.styleable.AnimateCheckBox_animUnCheckColor, DEFAULT_UNCHECK_COLOR);
        correctColor = a.getColor(R.styleable.AnimateCheckBox_animLineColor, DEFAULT_LINE_COLOR);
        correctWidth = a.getDimensionPixelSize(R.styleable.AnimateCheckBox_animLineWidth, DEFAULT_LINE_WIDTH);
