...
import com.topway.fine.utils.DensityUtil;
...
public class Sidebar extends View {
	...
	private void setHeaderTextAndscroll(MotionEvent event){
		...
		Object base = mListView.getAdapter();
		if (base instanceof HeaderViewListAdapter) {
			HeaderViewListAdapter wrappe = (HeaderViewListAdapter)base;
			base = wrappe.getWrappedAdapter();
		}
		if (base instanceof SectionIndexer) {
			adapter = (SectionIndexer)base;
		}
		if (adapter == null)
			return;
