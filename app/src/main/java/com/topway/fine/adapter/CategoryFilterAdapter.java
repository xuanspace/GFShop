...
public class CategoryFilterAdapter extends BaseAdapter implements StickyListHeadersAdapter, SectionIndexer {
    ...
    public String getItemText(int position) {
        Category brand = (Category) mDataList.get(position);
    ...
    public void buildIndex() {
        if (mDataList != null && mDataList.size()>0) {
            for (int i = 0; i < mDataList.size(); i++) {
                Category item = (Category) mDataList.get(i);
